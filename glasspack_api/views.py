...
class PaginationProductViewSet(PageNumberPagination):
    page_size = 6
...
class ProductViewSet(viewsets.ModelViewSet):
    ...
    pagination_class = PaginationProductViewSet
    ...
    def parameters(self, request):
        ...
        serializer = SelectedFiltersSerializer(instance=data)
        return Response(serializer.data)
    

class UserMessageView(mixins.CreateModelMixin, viewsets.GenericViewSet):
